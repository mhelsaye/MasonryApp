...
def effective_Section_image (n_clicks, H, t, fblock, S, bar, P_DL, P_LL, P_S, e, W):
    if S == 200 *mm:
        img = "https://raw.githubusercontent.com/mhelsaye/MasonryApp/4681f2823a73203bb38cca680d3ce0f9af9f1329/assets/EffectiveSection%20_%20FG.png"
    else:
...
def EquilbruimSection_image (n_clicks, H, t, fblock, S, bar, P_DL, P_LL, P_S, e, W):
    ...
    if S == 200*mm:
         img ="https://raw.githubusercontent.com/mhelsaye/MasonryApp/4681f2823a73203bb38cca680d3ce0f9af9f1329/assets/EquilibruimSection_FG.png"
    else:         
